...
case 6:return "ISTR";
break;
case 7:this.pushState("expr"); return yy_.yytext.toUpperCase();
break;
...
break;
case 13:this.pushState("code"); return "CODETAG";
break;
case 14:this.pushState("tag"); return "VOIDTAG";
break;
case 15:this.pushState("tag"); return "TAG";
break;
case 16:yy_.yytext = yy_.yytext.slice(1); return "TAGID";
break;
case 17:yy_.yytext = yy_.yytext.slice(1); return "TAGCLASS";
break;
case 18:yy_.yytext = yy_.yytext.slice(2).trimLeft(); return "TAGSRC";
break;
case 19:// ignore whitespace
break;
case 20:this.pushState("attrs"); return yy_.yytext;
break;
case 21:this.popState(); return yy_.yytext;
break;
case 22:return "ATTR";
break;
case 23:return "DATAATTR";
break;
...
case 26:// ignore
break;
case 27:this.popState(); return "TEXT";
break;
case 28:
  this.popState();
...
break;
case 29:yy_.yytext = ''; return "BLANKLINE";
break;
case 30:
  // Set level to length of string minus newline character.
...
case 31:return "LINE";
break;
case 32:this.pushState("name"); return "NSTART";
break;
case 33:return "ID";
break;
...
break;
case 50:this.pushState("raw"); return "RAW";
break;
case 51:return "TEXT";
break;
}
...
conditions: {"tag":{"rules":[0,1,2,16,17,18,19,20,27,32,38],"inclusive":true},"attrs":{"rules":[5,6,21,22,23,24,25,26,32],"inclusive":true},"name":{"rules":[5,6,10,32,33,34,35,36,37,38],"inclusive":true},"filter":{"rules":[1,32,38,45,46,51],"inclusive":true},"raw":{"rules":[1,2,32,38,51],"inclusive":true},"expr":{"rules":[5,6,8,9,10,11,12,32,33,34,35,38],"inclusive":true},"fn":{"rules":[5,6,10,32,33,34,35,39,40,41,42,43],"inclusive":true},"code":{"rules":[28,29,30,31,32],"inclusive":true},"INITIAL":{"rules":[0,1,2,3,4,7,13,14,15,32,38,44,47,48,49,50,51],"inclusive":true}}
};
indent_stack = [0];
filter_level = 0;
code_level = 0;;
