...
(function(exports) {
  ...
  function Manana(config) {
    ...
    // ...........................................  
    /**
     * Get a view's relative past relative.
     * @memberof Manana.history
     * @method getAncestor
     * @param {string} name - Name of the view to check against.
     * @param {string} relative - Name of the relative to look for. 
     */
    this.history.getAncestor = function(name, relative) {
     ...
     * @param {string} relative - Name of the relative to look for. 
     */
    this.history.getDescendant = function(name, relative) {
